...
export const SCENARIOS = [
...

  {
    ...
    categories: [
      ...
      { id: "internet",    name: "Internet",                   emoji: "📶", amount: 30,  type: "fixed",    tip: "Essential for Noah's homework and Sarah's work." },
      ...
      { id: "savings",     name: "Savings",                    emoji: "🐷", amount: 50,  type: "saving",   tip: "Sarah tries hard to save a little each month so that unexpected bills don't cause a crisis." },
    ],
    surprises: [
      ...
      { id: "medicine",  name: "Prescription charges",          emoji: "💊", amount: 30,  description: "Noah has an ear infection. The prescription is free for children, but Sarah needs medicine too — adults pay per item." },
      ...
      { id: "birthday",  name: "Noah's birthday party",        emoji: "🎂", amount: 80,  description: "Sarah wants Noah to have a small party with his friends. Even a simple one at home costs more than expected." },
      { id: "dental",    name: "Sarah's dentist appointment",   emoji: "🦷", amount: 65,  description: "An NHS check-up reveals a small filling is needed. Children's dental care is free — but not adults'." },
